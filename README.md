...
- [2. 架构（Level 2）](#2-架构level-2)
  - [2.1 总览](#21-总览)
  - [2.2 Core 0 — 大脑：四大组件](#22-core-0--大脑四大组件)
  - [2.3 Core 1 — 手：单任务执行器](#23-core-1--手单任务执行器)
  - [2.4 虚拟串口](#24-虚拟串口level-1--level-2-零改动迁移)
  - [2.5 相位锁定调度](#25-相位锁定调度)
  - [2.6 PAL vs FreeRTOS](#26-pal-调度器-vs-freertos-调度器)
  - [2.7 组件清单](#27-组件清单)
  - [2.8 组件交互图](#28-组件交互图)
- [3. PAL 协议](#3-pal-协议)
  - [3.1 消息格式](#31-消息格式)
